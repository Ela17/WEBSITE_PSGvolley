...
import { FaInstagram, FaDirections, FaRegCopyright, FaGithub } from 'react-icons/fa';
    ...
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          {/* Colonna 1: Info */}
          <div>
            <h3 className="font-bold text-lg mb-0">A.S.D. Patrocinio San Giuseppe</h3>
            <h4 className="font-bold text-md mb-3">Squadre di pallavolo mista</h4>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              >
                <span className="group-hover:underline">Via Pietro Baiardi 4, Torino</span>
        ...
        <div className="border-t border-gray-800 mt-6 pt-4 text-center text-sm text-gray-400">
          <p className="inline-flex items-center">
            ...
            {new Date().getFullYear()} ASD Patrocinio San Giuseppe. Tutti i diritti riservati.
          </p>
          <p className="mt-1">Sviluppato da Elena Derosas.
          <a
